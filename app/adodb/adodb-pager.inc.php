...
class ADODB_Pager {
	...
	//var $gridAttributes = 'width=100% border=1 bgcolor=#ff00ff';
	...
	function RenderGrid($gridAttributes = 'width=100% border=1 bgcolor=#ff00ff')
	{
	global $gSQLBlockRows; // used by rs2html to indicate how many rows to display
		include_once(ADODB_DIR.'/tohtml.inc.php');
		ob_start();
		$gSQLBlockRows = $this->rows;
		build_table($this->rs,false,$mainheaders,'Titulo de la Tabla','images/360/yearview.gif','50%','true');
		//rs2html($this->rs,$gridAttributes,$this->gridHeader,$this->htmlSpecialChars);
		$s = ob_get_contents();
		ob_end_clean();
		return $s;
	}
	...
	function Render($rows=10,$gridAttributes = 'width=100% border=1 bgcolor=#ff00ff')
	{
	global $ADODB_COUNTRECS;
		...
		$grid = $this->RenderGrid($gridAttributes);
