...
<?php
	...
	<br>
	<form action="can_add1.php" method="post" name="form1">
	<?php				
		$sqlpro="select pro_codigo,pro_nombre from provincia order by pro_nombre ";
		$campo=array(
						array("etiqueta"=>"* Provincia","nombre"=>"clp0","tipo_campo"=>"select","sql"=>$sqlpro,"valor"=>""),
		...
		build_add($conn,'false',"Añadir Cantón","images/360/personwrite.gif","50%",'true'
		,$campo,$campo_hidden);
