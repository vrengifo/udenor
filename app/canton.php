...
<?php
    ...
    <input type="button" name="Add" value="Añadir" onClick="self.location='can_add.php<?=$param_destino?>'">
...
<?php	
		...
		else
		{
			...
			$mainheaders=array("Eliminar","Provincia","Cantón","Foto","Modificar");		
			build_table_admin($recordSet,false,$mainheaders,'Cantón ',
