...
function valida() {
	...
	<br>
	<form action="cons_codigo.php" method="post" name="form1">
	<?php
		$principal="cons_codigo.php";
	...
	<table border="0">
	<tr>
	  <td colspan="3">Proyectos por Código</td>
	</tr>
	<tr>
	  <td>	
	    <table>
	  ...
	  {  
		$codigo=trim($codigo);
	  	$sql="select dp.datpro_id from dato_proyecto dp "
			."where dp.datpro_codigo like '$codigo%' "
			."order by dp.datpro_codigo ";
		$rs=&$conn->Execute($sql);
		...
		<tr>
		  <td nowrap>
		    <SPAN class="title" STYLE="cursor:default;">
			  ...
			  <font color="#FFFFFF">Proyecto por Código&nbsp;</font>
			</SPAN>
		  </td>
		</tr>
	  </table>
