...
function valida() {
	...
	<table border="0">
	<tr>
	  <td colspan="3">Proyectos por Calificación</td>
	</tr>
	<tr>
	  <td>	
	    <table>
	      <tr>	    
            <td colspan="2">
              Escoja la Opción deseada, si se ingresan los valores en Calificación entre se hará la consulta entre rangos,
               si no se ingresó uno de los dos valores el sistema asume que escogió la segunda opción que es Calificación por valor.  
               En caso de no ingresarse un valor para la Calificación por valor el sistema mostrará todas las calificaciones que posee.
            </td>
	      </tr>
	      </tr>
	      <tr>	    
            <td>Calificación Entre (Rangos): </td>
		    <td>			  
...
<?php	        
	  ...
	  {  
		...
		{
		  $sql.="where total_puntaje>=$desde and total_puntaje<=$hasta ";
		...
		else //opción
		{
		  if(strlen($valor)>0)
		  {
		  	$sql.="where total_puntaje$operador$valor ";
		  }
		}
		$sql.="order by total_puntaje desc";	
		$rs=&$conn->Execute($sql);
		...
		<tr>
		  <td nowrap>
		    <SPAN class="title" STYLE="cursor:default;">
			  ...
			  <font color="#FFFFFF">Proyecto por Calificación&nbsp;</font>
			</SPAN>
		  </td>
		</tr>
	  </table>
