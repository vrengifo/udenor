...
function valida() {
	...
	<br>
	<form action="cons_tramite.php" method="post" name="form1">
	<?php
		$principal="cons_tramite.php";
	...
	<table border="0">
	<tr>
	  <td colspan="3">Proyectos por Estado de Trámite</td>
	</tr>
	<tr>
	  <td>	
	    <table>
...
<?php	        
	  ...
	  {  
		...
		if($estado!="0")
		{
		  $sql.="where est_codigo=$estado "
		  	   ."order by datpro_codigo ";	
		}
		$rs=&$conn->Execute($sql);
