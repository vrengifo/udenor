...
function valida() {
  ...
  <input type="button" name="Add" value="Añadir" onClick="self.location='dpdoc_add.php<?=$param_destino?>'">  
...
<?php	
        ...
        if (!$recordSet||$recordSet->EOF) 
			echo('No existe documentación del Proyecto.  Click en el botón Añadir para ingresar documentación');
		else
		{

			$mainheaders=array("Eliminar","Tipo Documento","Código","Nombre Doc.","Path Doc.","Modificar");		
			build_table_admin($recordSet,false,$mainheaders,'Documentación ',
