...
function valida() {
  ...
  <input type="button" name="Add" value="Añadir" onClick="self.location='dpent_add.php<?=$param_destino?>'">  
...
<?php	
        ...
        if (!$recordSet||$recordSet->EOF) 
			echo('No existen datos de Entidades, crear dando click en el botón Añadir.');
		else
		{
