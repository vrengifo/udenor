...
/* Usuario */
insert into subaplicacion values (0,2,'Tipo Usuario','tipousuario.php','images/360/person.gif',1);
...
insert into subaplicacion values (0,3,'Indicador','indicador.php','images/360/person.gif',14);
insert into subaplicacion values (0,3,'Indicador x Cantón','indicadorxcanton.php','images/360/person.gif',15);
insert into subaplicacion values (0,3,'Objetivo Udenor','objetivoudenor.php','images/360/pubfile.gif',16);
insert into subaplicacion values (0,3,'Estado Avance Proyecto','estadoavanpro.php','images/360/pubfile.gif',17);
insert into subaplicacion values (0,3,'Vialidad Participativa','vialidad.php','images/360/pubfile.gif',18);
insert into subaplicacion values (0,3,'Beneficio Ambiental','beneficio.php','images/360/pubfile.gif',19);

insert into subaplicacion values (0,3,'Parámetros','parametro.php','images/360/person.gif',20);

/* Proyecto */
insert into subaplicacion values (0,4,'Ingreso Proyectos','proyecto.php','images/360/pubfile.gif',1);
insert into subaplicacion values (0,4,'Consultas','consulingpro.php','images/360/pubfile.gif',3);

insert into subaplicacion values (0,4,'Proyectos x Ingreso Proyectos','datoproyecto.php','images/360/pubfile.gif',2);
...
insert into subaplicacion values (0,5,'Objetivo Udenor','objetivoudenor.php','images/360/pubfile.gif',3);
insert into subaplicacion values (0,5,'Estado Avance Proyecto','estadoavanpro.php','images/360/pubfile.gif',4);
insert into subaplicacion values (0,5,'Vialidad Participativa','vialidad.php','images/360/pubfile.gif',5);
insert into subaplicacion values (0,5,'Beneficio Ambiental','beneficio.php','images/360/pubfile.gif',6);
