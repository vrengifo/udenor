...
function filter_action(forma)
{
    ...
    location_url="modipriorizacion.php";
    location_url=location_url+"?filter1="+forma.filter1.value+"&filter2="+forma.filter2.value;
...
<?php
	$campo=array(
			array("etiqueta"=>"Código Proyecto (Ej: DP:1:A:1)","nombre"=>"filter1","tipo_campo"=>"text","sql"=>"","valor"=>""),
			array("etiqueta"=>"Descripción","nombre"=>"filter2","tipo_campo"=>"text","sql"=>"","valor"=>"")
		);
