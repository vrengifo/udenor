...
<?php
	...
	<br>
	<form action="mon_add1.php" method="post" name="form1">
	<?php				
		$campo=array(
						array("etiqueta"=>"* Código ","nombre"=>"clp0","tipo_campo"=>"text","sql"=>"","valor"=>""),
						array("etiqueta"=>"* Nombre","nombre"=>"clp1","tipo_campo"=>"text","sql"=>"","valor"=>""),
						array("etiqueta"=>"* Equivalencia a Dolar","nombre"=>"clp2","tipo_campo"=>"text","sql"=>"","valor"=>"")
					);
		$campo_hidden=array(
		...
		build_add($conn,'false',"Añadir Moneda","images/360/personwrite.gif","50%",'true'
		,$campo,$campo_hidden);
