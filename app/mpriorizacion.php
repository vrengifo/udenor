...
<?php
	...
	<?php				
		...
		build_show($conn,'false',"Información de Proyecto","images/360/taskwrite.gif","50%",'true'
		,$campo,$campo_hidden,$id);
		//construye el html para los campos relacionados
		/*
		build_upd($conn,'false',"Actualizar Proyecto","images/360/memowrite.gif","50%",'true'
		,$campo,$campo_hidden,$id);
		*/
...
<?
		...
		$resto_sub="&principal=priorizacion.php";
?>		
	<!--
	<input type="button" name="bpriorizar" value="Priorizar con Asistente" onClick="fOpenWindow('wpriorizacion.php<?=$param_sub?><?=$resto_sub?>','PriorizacionAsistente','450','550')">
	-->
	<br>	
		<input type="button" name="bobj" value="Objetivos Udenor" onClick="fOpenWindow('probjetivo.php<?=$param_sub?><?=$resto_sub?>','PrObjetivoUdenor','450','550')">
		<input type="button" name="bestado" value="Estado Avance Proyecto" onClick="fOpenWindow('prestadoava.php<?=$param_sub?><?=$resto_sub?>','DPDatoTecnico','450','550')">
		<input type="button" name="bbensoc" value="Beneficio Social" onClick="fOpenWindow('prsocial.php<?=$param_sub?><?=$resto_sub?>','DPEntidad','450','550')">
		<input type="button" name="bbeneco" value="Beneficio Económico" onClick="fOpenWindow('preconomico.php<?=$param_sub?><?=$resto_sub?>','DPDocumentac','450','550')">
	<br>	
		<input type="button" name="bbeneco" value="Vialidad Participativa" onClick="fOpenWindow('prvialidad.php<?=$param_sub?><?=$resto_sub?>','DPDocumentac','450','550')">
		<input type="button" name="bbeneco" value="Contrapartida" onClick="fOpenWindow('prcontra.php<?=$param_sub?><?=$resto_sub?>','DPDocumentac','450','550')">
		<input type="button" name="bbeneco" value="Beneficio Ambiental" onClick="fOpenWindow('prambiental.php<?=$param_sub?><?=$resto_sub?>','DPDocumentac','450','550')">
		<input type="button" name="bver" value="Ver" onClick="fOpenWindow('verproyecto.php<?=$param_sub?><?=$resto_sub?>','Ver','450','550')">		
		<input type="button" name="bcalificar" value="Calificar" onClick="fOpenWindow('prcalificar.php<?=$param_sub?><?=$resto_sub?>','Ver','450','550')">
		<br>
		<br>			
	</form>	
