...
<?php
	...
	<?php				
		...
		$campo=array(
						...
						array("etiqueta"=>"* Empleado entrega","nombre"=>"clp5","tipo_campo"=>"select","sql"=>$sqlemp,"valor"=>$obj->ingpro_empentrega),
		...
		build_upd($conn,'false',"Ingreso de Proyecto Añadido","images/360/memowrite.gif","50%",'true'
