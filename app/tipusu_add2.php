...
<?php
	...
	<?php				
		...
		$campo=array(
						array("etiqueta"=>"* Código Tipo Usuario","nombre"=>"clp0","tipo_campo"=>"text","sql"=>"","valor"=>$obj->tipusu_codigo),
		...
		build_upd($conn,'false',"Tipo de Usuario Añadido","images/360/memowrite.gif","50%",'true'
