...
<br>	
	...
	<?php				
		...
		$campo=array(
						array("etiqueta"=>"* Componente","nombre"=>"compo","tipo_campo"=>"hidden","sql"=>$sqlcom,"valor"=>$com1ro,"js"=>""),
						array("etiqueta"=>"* Subcomponente","nombre"=>"subcompo","tipo_campo"=>"hidden","sql"=>$sqlpro,"valor"=>$pro1ro,"js"=>""),
						array("etiqueta"=>"* Tipo","nombre"=>"tipo","tipo_campo"=>"select","sql"=>$sqltipo,"valor"=>$tipo,"js"=>""),
	...
	?>
		...
		<input type="submit" name="Update" value="Continuar" onclick="cambiar_action(form1,'wdatpro_upd1.php');">
