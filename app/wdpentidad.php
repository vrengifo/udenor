...
<?php
		...
		$param_sub="dpentidad.php?id_aplicacion=$id_aplicacion&id_subaplicacion=$id_subaplicacion&idp=$id&principal=wpubicacion.php";
		$param_sub1="?id_aplicacion=$id_aplicacion&id_subaplicacion=$id_subaplicacion&idp=$id&principal=wpubicacion.php";
		$param_atras="wdptecnico.php?id_aplicacion=$id_aplicacion&id_subaplicacion=$id_subaplicacion&id=$id&idp=$idp";
		$param_sig="wdpdocumento.php?id_aplicacion=$id_aplicacion&id_subaplicacion=$id_subaplicacion&id=$id&idp=$idp";
...
<p> 
  Si Ud. no ha ingresado Entidades por favor de click en el bot&oacute;n &quot;Ingresar / Eliminar / Modificar Entidades&quot;. 
  Aqu&iacute; usted podr&aacute; ingresar o eliminar o modificar las Entidades Solicitantes, Operadoras y Financistas del Proyecto. 
</p>
<p>Para continuar con el siguiente paso de click en el bot&oacute;n &quot;Continuar&quot; </p>
<br>	
	<input type="button" name="bubi" value="Ingresar / Eliminar / Modificar Entidades" onClick="fOpenWindow('<?=$param_sub?>','DPEntidad','450','550')">
