...
<p> 
  Si Ud. no ha ingresado datos Técnicos por favor de click en el bot&oacute;n &quot;Ingresar / Eliminar / Modificar Datos Técnicos&quot;. 
  Aqu&iacute; usted podr&aacute; ingresar o eliminar o modificar el estado de Desarrollo, fecha inicial y final, duración, beneficiarios,
   monto, moneda del proyecto así como un detalle de valores que inviertan Entidades para dicho proyecto. 
</p>
<p>Para continuar con el siguiente paso de click en el bot&oacute;n &quot;Continuar&quot; </p>
<br>	
	<input type="button" name="bubi" value="Ingresar / Eliminar / Modificar Datos Técnicos" onClick="fOpenWindow('<?=$param_sub?>','DPUbicacion','450','550')">
