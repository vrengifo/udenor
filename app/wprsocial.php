...
<br>  
  <form action="wprsocial1.php" method="post" name="form1">
	<?php				
...
<?
  ...
  $param_atras="wprestadoava.php?id_aplicacion=$id_aplicacion&id_subaplicacion=$id_subaplicacion&idp=$idp";
  $param_sig="wpreconomico.php?id_aplicacion=$id_aplicacion&id_subaplicacion=$id_subaplicacion&idp=$idp";
?>
<p> 
  Si Ud. no ha ingresado Total de beneficiarios directos por favor ingréselo. 
</p>
...
<?			
	...
	if(!$res)
	{
	  $obj->ben_totalparroquias=$opadre->totalbeneficiarios($idp);	
		...
		build_add($conn,'false',"Beneficio Social","images/360/personwrite.gif","50%",'true'
		,$campo,$campo_hidden);				
?>	
  </form>
